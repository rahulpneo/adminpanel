            ...
            <div class="tabbable-line boxless tabbable-reversed">
                <div class="portlet box blue-hoki">
                    ...
                    <div class="portlet-body form" style="display: block;">
                    	@include('error')
                        <!-- BEGIN FORM-->
                        <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" id="create_category" class="form-horizontal">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group @if($errors->has('category')) has-error @endif">
									...
									<div class="col-md-4">
									<input type="text" id="category-field" name="category" class="form-control validate[required]" value="{{ is_null(old("category")) ? $category->category : old("category") }}"/>
