		    ...
		    <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        ...
                        <div >
                        	<a class="label-info btn-outline btn-circle btn-sm" href="{{ route('admin.categories.create') }}" style="color:#fff;text-decoration: none;">
...
<script>
	$(document).ready(function(){
		$('#categories-records').dataTable({
			"ajax": "<?php echo url('/admin/ajax_get_categories');?>",
	        "columns": [
	            { "data": "sr_no" },
	            { "data": "category_name" },
	            { "data": "status" },
